...
<head>
		...
		<link href="res/assets/css/login.css" rel="stylesheet" type="text/css" />
</head>
	<body>
		<div class="errorMsg">
			<!-- Change this text based on the error message -->
			<span>Ooops! No hemos podido verificar tu usuario y contraseña. Por favor inténtelo de nuevo.</span>
		...
		<script src="res/assets/js/login.js" type="text/javascript"></script>
	</body>
</html>