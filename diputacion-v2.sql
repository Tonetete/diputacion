...
INSERT INTO `ASIGNACION_FIJO` VALUES ('2013-01-01','2013-12-31','13163532B',36,32,1,1,NULL,'S');
...
INSERT INTO `LLAMADA` VALUES (1,36,'952334312',NULL,1060,4.200,'2013-05-04 13:56:00','2013-05-04 14:16:00'),(2,36,'952312353',NULL,1060,3.000,NULL,NULL),(3,36,'952336762',NULL,1060,3.000,NULL,NULL),(4,36,'952334311',NULL,1060,3.000,NULL,NULL);
...
CREATE TABLE `PLAN_CONCERTACION` (
  ...
  CONSTRAINT `fk_PLAN_codigo_dip` FOREIGN KEY (`codigo_dip`) REFERENCES `DIPUTACION` (`codigo`),
...
CREATE TABLE `TAREA` (
  ...
  KEY `dni_tarea_asignado` (`dni_tarea_asignado`),
  KEY `codigo_perfil` (`codigo_perfil`),
  KEY `codigo_categoria` (`codigo_categoria`),
  KEY `codigo_numero` (`codigo_numero`),
  KEY `codigo_terminal` (`codigo_terminal`),
  KEY `tipo_tarea` (`tipo_tarea`),
  ...
  CONSTRAINT `tarea_TAREA_codigo_categoria` FOREIGN KEY (`codigo_categoria`) REFERENCES `CATEGORIA` (`codigo`),
  CONSTRAINT `tarea_TAREA_codigo_numero` FOREIGN KEY (`codigo_numero`) REFERENCES `LINEA` (`codigo`),
  CONSTRAINT `tarea_TAREA_codigo_perfil` FOREIGN KEY (`codigo_perfil`) REFERENCES `PERFIL` (`codigo`),
  CONSTRAINT `tarea_TAREA_codigo_terminal` FOREIGN KEY (`codigo_terminal`) REFERENCES `TERMINAL` (`codigo`),
  CONSTRAINT `tarea_TAREA_dni` FOREIGN KEY (`dni_tarea_asignado`) REFERENCES `USUARIO` (`dni`),
  CONSTRAINT `tarea_TAREA_tipo_tarea` FOREIGN KEY (`tipo_tarea`) REFERENCES `TIPO_TAREA` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TERMINAL` (
  ...
  `numero_interno` varchar(40) DEFAULT NULL,
  `pedido` varchar(400) DEFAULT NULL,
...
INSERT INTO `TERMINAL` VALUES (1,'2013-01-01','2013-12-31','Samsung','Galaxy Nexus','MOVIL',123,'','',''),(2,'2013-01-02','2013-12-31','Samsung','Samsung Galaxy S3','MOVIL',124,'','',''),(3,'2013-01-04','2013-12-31','iPhone','4S','MOVIL',125,'','',''),(4,'2013-01-05','2013-12-31','iPhone','5','MOVIL',126,'','',''),(5,'2013-01-06','2013-12-31','Nokia','Lumia','MOVIL',127,'','',''),(6,'2013-01-07','2013-12-31','HTC','ONE','MOVIL',128,'','',''),(7,'2013-01-08','2013-12-31','HTC','Hero','MOVIL',129,'','',''),(8,'2013-01-09','2013-12-31','HTC','Wildfire','MOVIL',130,'','',''),(9,'2013-01-10','2013-12-31','Alcatel','G400','MOVIL',131,'','',''),(10,'2013-01-11','2013-12-31','LG','Nexus 4','MOVIL',132,'','',''),(11,'2013-01-12','2013-12-31','Sony','Xperia P','MOVIL',133,'','',''),(12,'2013-01-13','2013-12-31','Sony','Xperia S','MOVIL',134,'','',''),(13,'2013-01-14','2013-12-31','Sony','Xperia U','MOVIL',135,'','',''),(14,'2013-01-15','2013-12-31','LG Optimus','L5','MOVIL',136,'','',''),(15,'2013-01-16','2013-12-31','Samsung','Galaxy Ace 2','MOVIL',137,'','',''),(16,'2013-01-17','2013-12-31','HTC','Desire X','MOVIL',138,'','',''),(17,'2013-01-18','2013-12-31','Blackberry','Curve','MOVIL',139,'','',''),(18,'2013-01-19','2013-12-31','Nokia','Lumia 710','MOVIL',140,'','',''),(19,'2013-01-20','2013-12-31','Motorola','MOTOLUXE','MOVIL',141,'','',''),(20,'2013-01-21','2013-12-31','Huawei','Ascend P1','MOVIL',142,'','',''),(21,'2013-01-22','2013-12-31','ZTE','Blade','MOVIL',143,'','',''),(22,'2013-01-23','2013-12-31','Nokia','5580','MOVIL',144,'','',''),(23,'2013-01-24','2013-12-31','Samsung','Google Nexus 7','MOVIL',145,'','',''),(24,'2013-01-25','2013-12-31','Philips','C300','FIJO',146,'','',''),(25,'2013-01-26','2013-12-31','Philips','C300','FIJO',147,'','',''),(26,'2013-01-27','2013-12-31','Philips','C300','FIJO',148,'','',''),(27,'2013-01-28','2013-12-31','Philips','C300','FIJO',149,'','',''),(28,'2013-01-29','2013-12-31','Philips','C300','FIJO',150,'','',''),(29,'2013-01-30','2013-12-31','Philips','C300','FIJO',151,'','',''),(30,'2013-01-31','2013-12-31','Philips','C300','FIJO',152,'','',''),(31,'2013-02-01','2013-12-31','Philips','C300','FIJO',153,'','',''),(32,'2013-02-02','2013-12-31','DOMO','D1','FIJO',154,'','',''),(33,'2013-02-03','2013-12-31','DOMO','D1','FIJO',155,'','',''),(34,'2013-02-04','2013-12-31','DOMO','D1','FIJO',156,'','',''),(35,'2013-02-05','2013-12-31','DOMO','D1','FIJO',157,'','',''),(36,'2013-02-06','2013-12-31','DOMO','D1','FIJO',158,'','',''),(37,'2013-02-07','2013-12-31','DOMO','D1','FIJO',159,'','',''),(38,'2013-02-08','2013-12-31','DOMO','D1','FIJO',160,'','',''),(39,'2013-02-09','2013-12-31','DOMO','D1','FIJO',161,'','',''),(40,'2013-02-10','2013-12-31','TELECOM','SPC','FIJO',162,'','',''),(41,'2013-02-11','2013-12-31','TELECOM','SPC','FIJO',163,'','',''),(42,'2013-02-12','2013-12-31','TELECOM','SPC','FIJO',164,'','',''),(43,'2013-02-13','2013-12-31','TELECOM','SPC','FIJO',165,'','',''),(44,'2013-02-14','2013-12-31','TELECOM','SPC','FIJO',166,'','',''),(45,'2013-02-15','2013-12-31','TELECOM','SPC','FIJO',167,'','',''),(46,'2013-02-16','2013-12-31','TELECOM','SPC','FIJO',168,'','',''),(47,'2013-02-17','2013-12-31','TELECOM','SPC','FIJO',169,'','',''),(48,'2013-02-18','2013-12-31','Siemens','Gigaset','FIJO',170,'','',''),(49,'2013-02-19','2013-12-31','Siemens','Gigaset','FIJO',171,'','',''),(50,'2013-02-20','2013-12-31','Siemens','Gigaset','FIJO',172,'','','');
...
-- Dump completed on 2013-05-14 20:03:15
